...
export default function Services(){
    return (
        <section className="services-container w-full px-4 md:px-[20px] lg:px-[120px] py-[20px] flex flex-col overflow-hidden gap-[20px] ">
            ...
            <div className="services-wraper w-full flex justify-center py-2 ">   
                <div className="w-[734px] flex flex-col gap-1">
                    ...
                    <h1 className="text-center text-[36px]  font-bold font-rem  ">Fostering a playful & engaging learning environment</h1>
                </div>
            </div>
